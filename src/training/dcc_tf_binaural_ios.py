...
class Net(nn.Module):
    ...
    # CHANGE: inputs provided as multiple args rather than as dict
    def forward(self, x, label, init_enc_buf=None, init_dec_buf=None,
        ...
        x = remove_padding_if_present(x, mod)
        
        out = x  # CHANGE: output is plain tensor rather than with wrapping dict
